...
def ResNet18(**kwargs):
    return ResNet(Bottleneck, DeconvBottleneck, [2, 2, 2, 2], 3, **kwargs)

def ResNet50(**kwargs):
    return ResNet(Bottleneck, DeconvBottleneck, [3, 4, 6, 3], 3, **kwargs)

def ResNet101(**kwargs):
    return ResNet(Bottleneck, [3, 4, 23, 2], 3, **kwargs)
